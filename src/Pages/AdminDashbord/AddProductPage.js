...
const AddProductPage = () => {
  ...
  const addProductHandler =async(e)=>{
    ...
    if(productDetail.title === '' || productDetail.price === "" || productDetail.category === '' || productDetail.description === "" || productDetail.productImageUrl === ''){
    ...
    try {
      ...
      toast.success('Add product sucesfully')
