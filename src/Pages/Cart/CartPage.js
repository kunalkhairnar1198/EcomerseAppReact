...
const CartPage = () => {
  return (
    <Layout>
    <div className="container mx-auto mt-10 max-w-7xl  lg:px-0">
                ...
                >
                    ...
                    <div>
                        ...
                        <div className="flex gap-4 mb-6">
                            <button
                                className="w-full px-4 py-3 text-center text-gray-100 bg-slate-800 border border-transparent dark:border-gray-700 hover:border-dark-700 hover:text-dark-700 hover:bg-slate-500 rounded-xl"
                            >
                                Checkout
                            </button>
                        </div>
