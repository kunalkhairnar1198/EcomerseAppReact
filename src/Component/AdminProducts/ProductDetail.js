    ...
    return (
        <div>
            <div className="py-5 flex mt-0  justify-between items-center">
                ...
                {/* Add Product Button  */}
                <NavLink to='/addproductpage' className="px-5 py-2 bg-slate-700 text-white hover:bg-slate-600 border border-medium--dark rounded-lg">Add Product</NavLink>
            </div>
