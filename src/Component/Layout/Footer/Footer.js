      ...
      <div className="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
        <div className="md:flex md:justify-between">
          <div className="mb-6 md:mb-0">
            <Link to="/" className="flex items-center gap-2">
              ...
              <span className="text-white text-lg font-semibold">KKshops</span>
            </Link>
          </div>
          <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
            <div>
              ...
              <ul className="text-gray-500 dark:text-gray-400 font-medium">
                <li className="mb-4">
                  <Link to="/admin-dashboard" className="hover:underline">Admin Login</Link>
                </li>
                <li className="mb-4">
        ...
        <div className="sm:flex sm:items-center sm:justify-between">
          <span className="text-sm text-gray-500 sm:text-center dark:text-gray-400">©2024  
            <Link to='#' className="hover:underline"> KKshops™ </Link>. All Rights Reserved.
          </span>
